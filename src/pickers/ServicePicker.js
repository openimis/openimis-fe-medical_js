  ...
  render() {
    ...
    return (
      <AutoSuggestion
        ...
        placeholder={
          !!withPlaceholder ? placeholder || formatMessage(intl, "medical", "ServicePicker.placehoder") : null
        }
...
export default injectIntl(connect(mapStateToProps, mapDispatchToProps)(withModulesManager(ServicePicker)));
